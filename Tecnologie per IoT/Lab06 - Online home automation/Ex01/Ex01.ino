...
void loop()
{
    ...
    if (registered)
    {
        ...
        /*
            N.B. Nella consegna non viene esplicitamente inserita la richiesta di inviare la temperatura quindi
            non è presente in questo programma, però questa azione viene svolta anche nel programma dell'es4
            quindi è possibile vedere la nosra implementazione lì.
        */
