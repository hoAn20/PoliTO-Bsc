...
//        System.out.println(theory_1.getTopics().stream().map(Topic::getKeyword).collect(Collectors.toList()));
...
//                    theory_1.getTopics().stream().map(Topic::getKeyword).collect(Collectors.toList()));
        ...
        System.out.println(ex_1.getTopics().stream().map(Topic::getKeyword).collect(Collectors.toList()));
