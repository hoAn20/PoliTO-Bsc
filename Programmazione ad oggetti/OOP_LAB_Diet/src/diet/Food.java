...
public class Food {
	...
	public final static double STANDARD_PORTION = 100.0;
	
	Map<String, NutritionalElement> rawMaterials;
	Map<String, NutritionalElement> products;
	Map<String, NutritionalElement> recipes;

	public Food() {
		this.rawMaterials = new TreeMap<>();
	 ...
	 */
	public void defineRawMaterial(String name, double cals,
			double prots, double carbs, double fats){
		
		this.rawMaterials.put(name,
				new RawMaterial(name, cals, prots, carbs, fats));
	}
	...
	public NutritionalElement getRawMaterial(String name){
		return this.rawMaterials.get(name);
	}
	 ...
	 */
	public void defineProduct(String name, double cals,
			double prots, double carbs, double fats){
		
		this.products.put(name, new Product(name, cals, prots, carbs, fats));
	}
	...
	public Menu createMenu(String name) {
		return new Menu(name, this.products, this.recipes);
	}
